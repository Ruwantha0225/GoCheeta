 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://soap.services.taxi.icbt.com/", wsdlLocation = "http://localhost:8080/taxi-services/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://soap.services.taxi.icbt.com/", "CustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/taxi-services/CustomerService?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://soap.services.taxi.icbt.com/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.services.taxi.icbt.com/", "CustomerServicePort"), CustomerService.class, features);
    }
