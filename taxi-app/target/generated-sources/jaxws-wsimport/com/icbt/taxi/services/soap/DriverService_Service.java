 ...
 * 
 */
@WebServiceClient(name = "DriverService", targetNamespace = "http://soap.services.taxi.icbt.com/", wsdlLocation = "http://localhost:8080/taxi-services/DriverService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DRIVERSERVICE_QNAME = new QName("http://soap.services.taxi.icbt.com/", "DriverService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/taxi-services/DriverService?wsdl");
    ...
    public DriverService getDriverServicePort() {
        return super.getPort(new QName("http://soap.services.taxi.icbt.com/", "DriverServicePort"), DriverService.class);
    }
    ...
    public DriverService getDriverServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.services.taxi.icbt.com/", "DriverServicePort"), DriverService.class, features);
    }
